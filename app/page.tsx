        ...
        <div className="max-w-5xl mx-auto px-5">
          ...
          <div className="flex gap-4 overflow-x-auto pb-4 justify-center flex-wrap sm:flex-nowrap">
            ...
            <SamplePage
              ...
              body="붉은 흙 위에서 아이들과 예배드렸다. 언어도, 문화도 달랐지만 같은 하나님을 향해 손을 들었다. 이 땅에도 하나님의 은혜가 가득함을 눈으로 보았다."
            />
            <SamplePage
              tag="성경학교 · 연세대 언더우드기념관"
              verse="믿음의 선진들이 증거하는 것은 — 히브리서 12:1"
              body="언더우드 선교사가 이 땅에 복음을 심기 위해 걸었던 길을 밟았다. 100년 전의 헌신이 오늘 내 신앙의 뿌리임을 기념관 앞에서 실감했다."
            />
            <SamplePage
              tag="셀 모임 · 목요일"
